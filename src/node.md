...
print('GİRİLEN SAYININ TAM KARE OLUP OLMADIĞINI SORGULAMA')
print()
...
if(kok*kok==num):
  print(num , 'TAMKARE bir sayıdır')
  print('Karekökü ' ,kok , 'dur')

else:
  print(num , 'sayısı TAMKARE OLMAYAN bir sayıdır')
